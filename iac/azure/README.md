...
Fill out the [quota-requests.csv](../sample-lab/quota-requests.csv) file with your expected resource usage for the hackathon. (The script will apply it for each subscription found in your tenant unless you limit the scope with the `-managementGroupId` parameter.)
