<#
.SYNOPSIS
Destroys the lab resources scoped to a subscription or resource group.
.DESCRIPTION
Provides a controlled teardown flow for lab environments, optionally limited to a resource group and specific Entra user IDs.
